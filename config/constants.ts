...
import { tenderlyStaging, sei, tenderlyStagingL1, tenderlyStagingL2 } from './tenderly'

export const ENVIRONMENT = process.env.NEXT_PUBLIC_ENVIRONMENT as 'development' | 'staging' | 'production'

const testNetChains = [tenderlyStaging, tenderlyStagingL1, tenderlyStagingL2] as const
...
export const tenderlyStagingBaseUrl = 'https://dashboard.tenderly.co/ion-protocol/money-market-v1/testnet/'
