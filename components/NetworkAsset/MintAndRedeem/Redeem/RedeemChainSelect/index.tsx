...
import { RedeemChainSelectConnector } from './connector'

function RedeemChainSelect({
  chains,
  onChange,
  selectedChainKey,
  placeholder,
  ...
  return (
    <Menu matchWidth>
      <MenuButton
        ...
        pointerEvents={role === 'destination' ? 'auto' : 'none'}
      >
...
export default RedeemChainSelectConnector.Connector(RedeemChainSelect)
